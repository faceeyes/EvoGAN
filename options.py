...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--life_count', type=int, default=30, help='life count')

        parser.add_argument('--generation_count', type=int, default=10, help='iter count')
        ...
        parser.add_argument('--namelist', type=str, default="000012.jpg", help='loaded images')
        ...
        parser.add_argument('--n_threads', type=int, default=0, help='number of workers to load GANdata.')
